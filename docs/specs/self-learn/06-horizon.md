...
|---|---|---|
| **0 — now** | v1 personal deployment per the corpus (M1–M3). The acceptance fixture is the only behavior-change evidence anywhere in this field at low volume (E-21) — run it honestly. *(Position, 2026-07-18: stage 0 is deployed and in daily use — M1–M3 shipped, the G-3 surface live, U12–U18 on top. The B-half fixture passed 2026-07-14; the month of supply-mix/queue-health numbers is accruing, O-3/O-7 revisit ≥2026-08-17. The packaging phase now starting is stage 1's on-ramp: it builds the install story before a second host asks.)* | Fixture passes; a month of real supply-mix and queue-health numbers |
