...
class TestConfigGet:
    ...
    def test_tier_field_matches_the_dispatch_ruling(self, tmp_path, monkeypatch, capsys):
        ...
        assert c_names == {
            ...
            # U8 (17-invocation-runbook.md §1): `invocation.backend_<surface>`
            # is generated by settings.py's `for _surface in SURFACES`
            # comprehension -- steward/overseer join it automatically,
